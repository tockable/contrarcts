...
contract TockableContractName is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    uint256 public constant DROP_TYPE = 0;
    ...
    function decodeIpfsHash(
        ...
        string memory part1 = bytes32ToString(ipfsHashOf[_tokenId].part1);
        string memory part2 = bytes32ToString(ipfsHashOf[_tokenId].part2);
